...
export default {
	model:'http://www.2nankai.cn/cer/h5.html',
 ...
 /* msgSend: params => {
  ...
  //获取角色范围
  msgRoleList: params =>{
    return API.POST('/api/msg/department',qs.stringify(params));
  },
  //按用户类型获取用户列表
  getlistType: params => {
    return API.POST('/api/msg/listType',qs.stringify(params));
  ...
  //按部门角色获取学生和家长用户列表
  selectFamilyAndStudent: params => {
    return API.GET('/api/msg/selectFamilyAndStudent',params);
  },
  //按角色获取用户列表
  ...
  //给教师发角色范围
  getDepart: params => {
    return API.GET('/api/msg/getDepart',params);
  },
  //老师给老师发送的人员列表
  getDepartTeacher: params => {
    return API.GET('/api/msg/getDepartTeacher',params);
  },
  //学生给老师发送的人员列表
  getOwnTeacher: params => {
    return API.GET('/api/msg/getOwnTeacher',params);
  },
  //获取消息列表
  getNewInfo: params =>{
    return API.GET('/api/message/getNewInfo',params);
  }
