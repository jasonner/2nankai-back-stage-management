...
//系统管理
const systemIntegration = () => import('@/components/systemIntegration/index.vue')
...
//      {path: '/userList', component: userList, name: '用户信息', menuShow: true},
  ...
  },
  {
    ...
    children: [
      ...
      {path: '/sendingStudent',code: '10104', component: newsManageStudent, name: '发送消息(学生和家长)',menuShow: true},
  ...
  },
  {
    ...
    children: [
      ...
      {path: '/systemIntegration',code: '10022', component: systemIntegration, name: '系统集成', menuShow: true},
    ]
  },
  {//个人信息
    path: '/',
