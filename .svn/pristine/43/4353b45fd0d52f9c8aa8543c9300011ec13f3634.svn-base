...
//  return API.GET('/api/log/list', params)
  ...
  //授课年级过滤
  skGrade: params => {
    return API.GET('/api/section/getGrade',params)
  },
  //授课根据年级获取班级
  skClass: params => {
    return API.GET('/api/section/getChildren',params)
  },
  
  //学科组，根据学科获得年级的信息
  gradeBysubject: params => {
    return API.GET('/api/subject/get',params)
  },
  
  //授课教师的导入
  springUpload: params => {
    return API.POST('/api/Execl/springUpload',qs.stringify(params))
  },
 }
