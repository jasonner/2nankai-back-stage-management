...
<div>
    <div class="modules-box">
        ...
        <div class="box-content" v-loading="loading">
                    ...
                    <el-form  class="demo-form-inline">
                        <el-row :gutter="20">
                            <div style="display:inline-block;width:60%;">
	                            <el-form-item>
			                        <el-input v-model="searchValue" placeholder="请输入账号，姓名，手机号进行搜索" @keyup.enter.native="search" prefix-icon="el-icon-search"></el-input>
			                    </el-form-item>
                            </div>
            ...
            <tableList :checkBox="true" :tableData='roleList' :pageNum="params.page" :pageSize="params.pageSize" :total="total" :columns="columns" @CurrentChange="handleCurrentChange(params.page)" @selectionChange="handSelectionChange"></tableList>
        </div>
		  ...
		  <div style="width:100%;padding-bottom:20px;border-bottom:1px solid #E5E5E5;text-align:center;overflow:hidden;" v-loading="loadinguser">
            ...
            <el-col :span="10" style="text-align:right;">
	       	...
	       	<div class="role" style="float:left;text-align:left;width:70%;">
			        ...
			        @current-change="handleCurrentChangeuser(paramsuser.pageSize)"
