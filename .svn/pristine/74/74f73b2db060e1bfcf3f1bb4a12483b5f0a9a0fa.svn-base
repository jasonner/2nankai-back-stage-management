    ...
    <div class="modules-box">
    	...
    	<div class="box-text">
    		...
    		<el-form style="width:48%;display:inline-block;text-align:right">
	    		...
	    		<el-button type="primary" @click="clear">清空操作日志</el-button>
    		</el-form>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { prop: "startTime", sortable:true,label: "时间" ,
          	 render: function (h, params) {
		            return h('span', 
		            formatDate(new Date(parseInt(this.row.startTime)), 'yyyy-MM-dd hh:mm')
		     )}
          },
          { prop: "ip", sortable:true,label: "Ip" },
          { prop: "description",sortable:true, label: "信息"},
          { prop: "uri", sortable:true,label: "接口路径" },
          { prop: "coreName", sortable:true,label: "浏览器名称" },
          { prop: "deviceName", sortable:true,label: "设备类型" }
        ],
      }
    },
	filters:{
