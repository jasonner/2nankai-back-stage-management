<template>
    <div class="content-box">
      <el-container>
        <el-aside width="260px" style="min-height:620px;margin-right:20px;" :showDlg.sync= 'show'  v-show="!show">
        ...
        <el-main>
          <line-chart  ref="child" @click="getNode" :showDlg.sync= 'show' v-if="!show"></line-chart>
...
<script>
  ...
  import viewUser from './component/viewUserData'
    export default {
      components: {LineChart,EdictUser,viewUser},
        name: "index",
        data() {
          return {
          	loading1:true,
